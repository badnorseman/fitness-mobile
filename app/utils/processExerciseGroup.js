...
function getExercise(exerciseGroup, exId) {
  for (let i = 0; i < exerciseGroup.exercises.length; i++) {
...
export default function processExerciseGroup(_exerciseGroup) {
  const exerciseGroup = _.cloneDeep(_exerciseGroup);
